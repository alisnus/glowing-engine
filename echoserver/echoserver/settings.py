...
SECRET_KEY = 'f-ppd50fb_=!t!2^*=ml6#io1cxc%9suf3x#+a_&u0y&k(py12'
...
TEMPLATES = [
    {
        ...
        'DIRS': [ # Убедитесь, что эта строка существует, чтобы Django искал шаблоны
            BASE_DIR / "echoserver/templates",
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    BASE_DIR / "static",  # Это путь к папке static на уровне проекта
]
